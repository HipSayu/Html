$(function(){
    $("#pieChart").drawPieChart([
      { title: "G7",              value : 50,  color: "#2C3E50" },
      { title: "Bạc Xỉu",    value:  8,   color: "#fe4400" },
      { title: "Cà phê sữa",          value:  24,   color: "#018ab6" },
      { title: "Capuchino", value : 16,   color: "#fff100" },
      { title: "G8",      value : 12,   color: "#D7DADB" }
    ]);
  });
